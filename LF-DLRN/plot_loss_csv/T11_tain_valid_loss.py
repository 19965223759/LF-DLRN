...
df1 = pd.read_csv('.\T11-train_val_loss1.csv')  # csv文件所在路径
...
plt.legend(fontsize=10)  # 图注的大小
plt.title('Training Loss and Validation Loss on T11 CT images',size=15)
plt.savefig(r'./T11_loss.jpg')
plt.show()
